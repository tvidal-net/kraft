...
import uk.tvidal.kraft.KRaftApplication.SUCCESS
...
@Description("spawn a local test cluster")
class ClusterTool(parser: OptionParser) : KRaftTool {

    internal companion object : KRaftLogging()

    private val opPath = parser.stringArgument("path to keep storage files", "path")
        .defaultsTo("./kraft")
